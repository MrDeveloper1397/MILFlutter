          ...
          items: [
            ...
            PopupMenuItem(
              ...
              onTap: () {
                flavorType == 'pragati'
                    ? Share.share(
                        'https://apps.apple.com/app/pragati-group/id6445843382')
                    :flavorType == 'virtusalifespaces'
                    ? Share.share(
                    'https://play.google.com/store/apps/details?id=task.marami.VirtusaLifespaces')
                    :
                Share.share(
                        'https://apps.apple.com/app/tricolour-properties/id6445861800');
              },
            ),
            PopupMenuItem(
              child: Text(
          ...
          Positioned(
            ...
            child: Card(
              ...
              child: Container(
                ...
                flavorType == 'virtusalifespaces'
                    ? Image.asset(
                  'assets/app_icon/vls_appicon.png',
                  fit: BoxFit.fill,
                )
                    :
                Image.asset(
