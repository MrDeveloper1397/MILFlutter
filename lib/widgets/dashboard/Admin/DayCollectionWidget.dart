                          ...
                          if (data.length > 0) {
                            for (int i = 0; i < data.length; i++) {
                              dayCollectionList.add(DayCollectionList(
                                  ...
                                  bankName: snapshot.data![i].bankName.toString(),
...
/*
                      Text(
                        ...
                        '${dayCollectionList[index].bankName} ',
                    ...
                    child: Container(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '${getPaymentType(dayCollectionList[index].acnumb,dayCollectionList[index].bankName)} ',
                            //'${dayCollectionList[index].bankName} ',
                            // '${dayCollectionList[index].acnumb} ',
                            style: TextStyle(
                              color: Colors.white,
...
*/
  ...
  getPaymentType(String acnumb,String bankname) {
