          ...
          child: Padding(
            ...
            flavorType == 'virtusalifespaces'
              ...
              children: [
                ...
                TextButton(
                  onPressed: () async {
                    await launch('https://www.google.com/maps/search/?api=1&query=201%2C+KKR+Square+Kavuri+Hills+Junction+Road+No.36%2C+Jubilee+Hills+Hyderabad%2C+Telangana-500033');
                  },
                  style: TextButton.styleFrom(
                    padding: const EdgeInsets.all(15),
                  ),
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 20.0),
                       ...
                       Text('201 KKR Square Kavuri Hills,\nJunction Road No.36,\nJubilee Hills,\nHyd - Telangana-500033.',
                          // 'Plot No: 1355A,\n3rd Floor, Road No: 1 & 45,\nAbove HDFC Bank,\nJubilee Hills,Hyd - 33.',
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 16.0,
                ...
                TextButton(
                  onPressed: () => launch('tel:+91-9154545454'),
                  style: TextButton.styleFrom(
                    padding: const EdgeInsets.all(15),
                  ),
                  child: Row(
                ...
                TextButton(
                  onPressed: () => launch(Uri(
                    scheme: 'mailto',
                    path: 'info@virtusalifespaces.com',
                  ).toString()),
                  style: TextButton.styleFrom(
                    padding: const EdgeInsets.all(15),
                  ),
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.mail,
                          color: Theme.of(context).primaryColor),
                      SizedBox(width: 20.0),
                      Text('info@virtusalifespaces.com',
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 16.0,
                              fontWeight: FontWeight.normal)),
                ...
                TextButton(
                  onPressed: () async {
                    const url = 'https://www.virtusalifespaces.com/';
                    await launch(url).catchError((e) => null);
                  },
                  style: TextButton.styleFrom(
                    padding: const EdgeInsets.all(15),
                  ),
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.language,
                          color: Theme.of(context).primaryColor),
                      SizedBox(width: 20.0),
                      Text('https://www.virtusalifespaces.com',
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 16.0,
                              fontWeight: FontWeight.normal)),
